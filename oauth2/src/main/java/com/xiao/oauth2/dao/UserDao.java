package com.xiao.oauth2.dao;

import com.xiao.oauth2.pojo.MenuInfo;
import com.xiao.oauth2.pojo.RoleInfo;
...
public class UserDao {
    private static RoleInfo admin = new RoleInfo(1,"管理员", "admin");
    ...
    public UserInfo getUserByName(String username){
        ...
        if ("admin".equals(username)){
            ...
            roles.add(developer);
            roles.add(player);
            return new UserInfo("admin", "123456", roles);
        }
